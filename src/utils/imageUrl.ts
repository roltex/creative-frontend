...
function getBackendBaseUrl(): string {
  ...
  if (typeof window !== 'undefined') {
    ...
    if (origin.includes('creativegeorgia.ge')) {
      return 'https://api.creativegeorgia.ge'
    }
    ...
    if (typeof window !== 'undefined') {
      ...
      if (origin.includes('creativegeorgia.ge')) {
        if (imagePath.includes('localhost:8000')) {
          return imagePath.replace('http://localhost:8000', 'https://api.creativegeorgia.ge')
        }
      } else if (origin.includes('creative.buildweb.dev') || origin.includes('creative-georgia.ge')) {
        if (imagePath.includes('localhost:8000')) {
